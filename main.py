...
openai.api_key = "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"


app = Flask(__name__)
app.config["MONGO_URI"] = "mongodb+srv://ankesh852131:ankesh@cluster0.8vum5yu.mongodb.net/chatgpt"
mongo = PyMongo(app)
